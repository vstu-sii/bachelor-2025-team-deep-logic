...
- **Вход/результат:** фио/email/пароль → созданный аккаунт.  
...
- **Вход/результат:** приготовленные рецепты → запись в истории.  
