...
- [Руководство пользователя](../docs/user-guide.md) - подробное руководство для конечных пользователей
- [Архитектура системы](../docs/architecture/C4%20+%20ADR.md) - техническая документация для разработчиков
