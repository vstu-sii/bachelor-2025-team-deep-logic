...
- [Руководство пользователя](../docs/user_guide.md) - подробное руководство для конечных пользователей
- [Архитектура системы](../docs/architecture.md) - техническая документация для разработчиков
